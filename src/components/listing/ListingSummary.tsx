  ...
  return (
    <View>
      <View className="flex-row items-center gap-1.5">
        <SymbolView name="mappin" tintColor="#3B82F6" size={17} weight="semibold" />
        <Text className="text-[14px] font-semibold text-[#3B82F6]">
          {distanceFromCampusKm} km from campus
        </Text>
      </View>

      <Text className="mt-2 text-[22px] font-bold text-[#0F172A]">
        {title}
      </Text>
      ...
      <View className="mt-2 flex-row items-center justify-between">
        <View className="flex-row items-baseline gap-1">
          ...
          <Text className="text-[14px] text-[#94A3B8]">/month</Text>
        </View>
